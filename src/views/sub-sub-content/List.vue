...
<div>
    ...
    <CCol col>
      <CCard>
        <CCardHeader>
			<div class="row">
				<div class="col-md-6">
          			<CIcon name="cil-justify-center"/><strong>Sub Sub Content List</strong>
				</div>
				<div class="col-md-6">
  ...
  <b-modal id="modal-1"
	...
	header-text-variant="light"
  	title="Sub Sub Content Entry" hide-footer>
    <div>
		<Form :id='editId'/>
  </div>
  </b-modal>
...
export default {
    ...
    computed: {
		...
		fields () {
			const labels = [
				...
				{ label: 'Content', class: 'text-center' },
	...
	methods: {
		...
		loadData () {
			...
			RestApi.getData(baseUrl, 'api/sub-sub-content/list', params).then(response => {
				if (response.success) {
