                                        ...
                                        <ValidationObserver ref="form2"  v-slot="{ handleSubmit, reset }">
                                            <b-form  @submit.prevent="handleSubmit(register(setting))" @reset.prevent="reset" >
                                                <div class='row'>
                                                    ...
                                                    <b-col lg="6" sm="6">
                                                        <ValidationProvider name="Point Conv Notice Box" vid="convert_notice" rules="required">
                                                            <b-form-group
                                                            class="row"
                                                            label-cols-sm="12"
                                                            label-for="formData"
  ...
  methods: {
    getData () {
        ...
        RestApi.getData(baseUrl, 'api/app-update/show').then(response => {
            if (response.success) {
                this.update = {
                    maintance: response.data.maintance ? true : false,
                    task_on_off: response.data.task_on_off ? true : false,
