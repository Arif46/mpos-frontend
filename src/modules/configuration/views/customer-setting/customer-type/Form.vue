                    ...
                    <ValidationObserver ref="form"  v-slot="{ handleSubmit, reset }">
                        <b-form  @submit.prevent="handleSubmit(formSubmit)" @reset.prevent="reset" >
                            <b-row>
                              ...
                              <b-col>
                                  <Input @return-value="setReturnData({ discount: $event})" :input="{ cols: 12, type: 'text', name: 'Discount', rules: 'required', vmodel: formData.discount }"/>
                              </b-col>
                            </b-row>
...
import { customerTypeStore, customerTypeUpdate } from '../../../api/routes'
...
export default {
  ...
  methods: {
    async formSubmit () {
      const result = this.submitHandler(customerTypeStore, customerTypeUpdate, this.formData)
